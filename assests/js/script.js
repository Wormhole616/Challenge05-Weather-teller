...
function getCurrentWeather(thisCity, id) {
    ...
    $.ajax({
        ...
        $(".cityToday").append(`<p>Feels Like: ${data.main.feels_like} &degF</p>`)
        $(".cityToday").append(`<p>Max: ${data.main.temp_max} &degF</p>`)
        $(".cityToday").append(`<p>Min: ${data.main.temp_min} &degF</p>`)
